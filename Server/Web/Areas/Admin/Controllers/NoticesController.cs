...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class NoticesController : Controller
    {
        ...
        public NoticesController(StudentDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,PostType,FutureNotification,EventDate,File")] Notice notice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,PostType,FutureNotification,EventDate,File")] Notice notice)
        {
            if (id != notice.Id)
            {
                return NotFound();
